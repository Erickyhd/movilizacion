...
<template>
  <AppLayout>
    <div class="w-full space-y-6">
              ...
              <tr v-for="v in filteredVehiculos" :key="v.id" :class="['hover:bg-slate-50/80 transition', !v.activo ? 'bg-red-50/30 opacity-75' : '']">
                ...
                <td class="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                  <button 
                    ...
                    class="p-2 text-purple-600 hover:text-purple-800 bg-purple-50 hover:bg-purple-100 border border-purple-200/80 rounded-xl transition cursor-pointer"
                  >
                    <Edit3 class="w-4 h-4" />
                  </button>
                  <button 
                  ...
                  >
                    <component :is="v.activo ? Trash2 : RotateCcw" class="w-4 h-4" />
                  </button>
                </td>
              </tr>
              ...
              <tr v-for="c in filteredConductores" :key="c.id" :class="['hover:bg-slate-50/80 transition', !c.activo ? 'bg-red-50/30 opacity-75' : '']">
                ...
                <td class="px-6 py-4 text-right space-x-2 whitespace-nowrap">
                  <button 
                    ...
                    class="p-2 text-indigo-600 hover:text-indigo-800 bg-indigo-50 hover:bg-indigo-100 border border-indigo-200/80 rounded-xl transition cursor-pointer"
                  >
                    <Edit3 class="w-4 h-4" />
                  </button>
                  <button 
                  ...
                  >
                    <component :is="c.activo ? Trash2 : RotateCcw" class="w-4 h-4" />
                  </button>
                </td>
              </tr>
      ...
      <!-- Drawer Vehiculo -->
      <div v-if="isVehiculoDrawerOpen" class="fixed inset-0 z-50 overflow-hidden">
      ...
      <!-- Drawer Conductor -->
      <div v-if="isConductorDrawerOpen" class="fixed inset-0 z-50 overflow-hidden">
